These notes are for the EDITORS of seont
...
Make sure you have an ID range in the [idranges file](seont-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [seont-edit.owl](seont-edit.owl)

** DO NOT EDIT seont.obo OR seont.owl in the top level directory **

[../../seont.owl](../../seont.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/AgriculturalSemantics/seont) for details.
 ...
 * [seont-idranges.owl](seont-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/seont_terms.txt file
...
Note: the seont_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as seont.owl and seont.obo and places
 ...
 * https://github.com/AgriculturalSemantics/seont/releases
 * https://github.com/AgriculturalSemantics/seont/releases/new
...
what is in the `owl:versionIRI` of the derived seont.owl (`data-version` in
seont.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/seont.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/seont/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/AgriculturalSemantics/seont.svg?branch=master)](https://travis-ci.org/AgriculturalSemantics/seont)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/AgriculturalSemantics](https://travis-ci.org/profile/AgriculturalSemantics)
 2. click the "Sync account" button
 3. Click the tick symbol next to seont
