 ...
 * [seont.yml](seont.yml)
     * Determines how your purl.obolibrary.org/obo/seont/ redirects will be handled
     ...
     * Paste in the contents of [seont.yml](seont.yml)
 ...
 * [seont.md](seont.md)
     ...
     * Paste in the contents of [seont.md](seont.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
